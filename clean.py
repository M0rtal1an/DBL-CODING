...
data_query_Virgin_raw = """--sql
    SELECT id, created_at, in_reply_to_user_id, in_reply_to_screen_name, user_id, user_name, user_screen_name, user_followers_count, user_friends_count, user_listed_count,user_favourites_count, user_location, user_verified, text
    FROM tweets
